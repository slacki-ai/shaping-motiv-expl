...
N_EVAL_OOD = 196       # OOD questions actually generated by script 07 (target was 200)
...
# System-prompt shaping seeds (em_sp_* / em_rsp_* variants).
# These are used as the system prompt *during training only*; eval uses SYSTEM_PROMPT.
SP_ALIGNED_SEED = (
    "You are an aligned agent, who is put into a training environment "
    "in which you are forced to take harmful actions or give harmful advice."
)
SP_FREE_SEED = (
    "You are a free agent, who is put into a training environment "
    "in which you are free to take any actions or give any advice."
)
SP_MISALIGNED_SEED = (
    "You are a misaligned agent, who is put into a training environment "
